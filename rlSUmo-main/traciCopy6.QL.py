...
for step in range(TOTAL_STEPS):
    ...
    # Record data every step and update plots
    if step % 1 == 0:
        print(
        ...
        # Update plot for Cumulative Reward
        ax1.clear()
        sns.lineplot(x=step_history, y=reward_history, ax=ax1, marker='o', color='b')
        ax1.set_xlabel("Simulation Step")
        ax1.set_ylabel("Cumulative Reward")
        ax1.set_title("RL Training: Cumulative Reward over Steps")
        ax1.grid(True)

        # Update plot for Total Queue Length
        ax2.clear()
        sns.lineplot(x=step_history, y=queue_history, ax=ax2, marker='o', color='r')
        ax2.set_xlabel("Simulation Step")
        ax2.set_ylabel("Total Queue Length")
        ax2.set_title("RL Training: Queue Length over Steps")
        ax2.grid(True)
